...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "runs/train/face_landmark_box_3002/weights/best.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="models/yolov5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/winder_face_6.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default=ROOT / "data/hyps/hyp.scratch-low.yaml", help="hyperparameters path")
    parser.add_argument("--epochs", type=int, default=300, help="total training epochs")
    parser.add_argument("--batch-size", type=int, default=192, help="total batch size for all GPUs, -1 for autobatch")
    ...
    parser.add_argument("--name", default="face_landmark_relative_box_300", help="save to project/name")
